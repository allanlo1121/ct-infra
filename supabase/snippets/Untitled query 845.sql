...
update proj.tunnel_risks
set  name = '测试11121'
where id = '4801c84c-767b-4306-8f97-3609056d1fec';

update tbm.tbm_assignments
set  updated_at = now()
where tbm_code = 'xre423';
...
select
    ...
    relreplident
from pg_class
where relname='tunnel_risks';

alter table proj.tunnel_risks
